...
double MutualInformation(int Na, int Nb, int Nab, int N)
{
	...
	*/
	...
	double PXab01 = PXb1 - PXab11; // Replace 0 with the correct formula
	double PXab10 = PXa1 - PXab11; // Replace 0 with the correct formula
	double PXab00 = PXa0 - PXab01; // Replace 0 with the correct formula
	double ret = 
